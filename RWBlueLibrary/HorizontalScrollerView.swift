...
protocol HorizontalScollerViewDataSource: class {
...
protocol HorizontalScollerViewDelegate: class {
...
class HorizontalScrollerView: UIView {
  weak var dataSource: HorizontalScollerViewDataSource?
  weak var delegate: HorizontalScollerViewDelegate?
